...
class Presupuesto {
    ...
    nuevoGasto(gasto) {
        this.gastos = [...this.gastos, gasto]; //Tomas una copia de gastos y se la pasa a gasto.
...
function preguntarPresupuesto() {
    ...
    if( presupuestoUsuario === '' || presupuestoUsuario === null || isNaN(presupuestoUsuario) || presupuestoUsuario <= 0 ) {
        window.location.reload(); //Recarga la ventana principal.
    }
    ...
    e.preventDefault();
     ...
     if(nombre === '' || cantidad === '') {
          ...
          ui.imprimirAlerta('Cantidad no válida', 'error')
            ...
            const { gastos} = presupuesto; //Extrae gastos de presupuesto.
